...
cli.add_argument("--in_file",  type=Path, default=Path("data/logic/deductive_logic.json"))
cli.add_argument("--out_file", type=Path, default=Path("data/corrupt/augmented_dataset.json"))
